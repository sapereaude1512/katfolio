...
module.exports = {
    "projects": [
        ...
        },
        {
            ...
            "achievements": [
                "Enhanced gameplay engagement through intuitive design",
                "Conducted in-depth user research and applied feedback",
                "Boosted platform usability and aesthetics",
                "Reduced user onboarding time by 25%",
                "Delivered fully functional prototype during the hackathon"
            ]
        }
    ]
};
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    container.addEventListener("click", (event)=>{
        ...
        if (toggleLabel) {
            ...
            currentContent.style.padding = isOpen ? "0rem 1rem" : "2rem 1rem";
        }
    });
});
...
//# sourceMappingURL=index.2e44d845.js.map
